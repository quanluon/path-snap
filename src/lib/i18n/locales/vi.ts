export const vi = {
  ...
  auth: {
    ...
    loginToUpload: 'Vui lòng đăng nhập để tải lên ảnh và video và tạo checkpoint.',
  },
  camera: {
    title: 'Thêm Checkpoint',
    selectImage: 'Nhấn để chọn ảnh hoặc video',
    selectVideo: 'Nhấn để chọn video',
    description: 'Mô tả (tùy chọn)',
    descriptionPlaceholder: 'Thêm mô tả cho checkpoint này...',
    locationCaptured: 'Đã lấy vị trí',
    locationNotAvailable: 'Vị trí không có sẵn',
    locationNotAvailableDesc: 'Ảnh sẽ được lưu mà không có thông tin vị trí',
    ...
    selectImageError: 'Vui lòng chọn ảnh hoặc video',
    locationRequired: 'Cần có vị trí. Vui lòng bật dịch vụ định vị.',
    uploadError: 'Tải file lên thất bại',
  },
  images: {
    noImages: 'Không tìm thấy ảnh',
  ...
  upload: {
    ...
    selectImage: 'Chọn ảnh hoặc video',
    dragDrop: 'Kéo thả ảnh hoặc video vào đây, hoặc nhấn để chọn',
    supportedFormats: 'Định dạng hỗ trợ: JPEG, PNG, WebP, MP4, WebM, MOV',
    maxSizeInfo: 'Kích thước file tối đa: 10MB (ảnh), 50MB (video)',
    duration: 'Thời lượng',
    maxDuration: 'Thời lượng tối đa: 30 giây',
  },
  settings: {
    title: 'Cài đặt',
